...
export const ui = {
  ...
  nameStyleDesc: 'Где располагается имя на плитке или выключить его.',
  ...
  timelineZoomAnchorLabel: 'Масштаб таймлайна',
  timelineZoomAnchorDesc: 'Что остаётся на месте при масштабировании таймлайна записей.',
  accentLabel: 'Акцент',
  ...
  nameStyleOff: 'Выкл.',
  zoomAnchorPointer: 'Курсор',
  zoomAnchorPlayhead: 'Указатель времени',
  accentCyan: 'Синий',
  accentSage: 'Зелёный',
  accentAmber: 'Жёлтый',
