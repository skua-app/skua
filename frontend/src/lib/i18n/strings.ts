...
export const ui = {
  ...
  storageDescription:
    'Disk usage for each mount Frigate reports. Figures come straight from Frigate and refresh only when you ask.',
  ...
  nameStyleDesc: 'Where the name sits on each tile, or off to hide it.',
  ...
  timelineZoomAnchorLabel: 'Timeline zoom',
  timelineZoomAnchorDesc: 'What zooming the recording timeline keeps in place.',
  accentLabel: 'Accent',
  ...
  nameStyleOff: 'Off',
  zoomAnchorPointer: 'Pointer',
  zoomAnchorPlayhead: 'Playhead',
  accentCyan: 'Cyan',
  accentSage: 'Sage',
  accentAmber: 'Amber',
  accentViolet: 'Violet',
