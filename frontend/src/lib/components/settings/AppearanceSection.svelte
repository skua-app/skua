<script lang="ts">
  ...
  // The option lists are shared with MobileAppearance, which renders the same
  // preferences in the phone layout. One copy, in $lib/appearance-options.
  import {
    themeOptions,
    nameStyleOptions,
...
<section id="appearance" class="settings-section dk-set-section">
  ...
  <div class="dk-card">
    ...
    <div class="dk-setline">
      <div class="sl-l">
        <div class="t">{ui.timelineModeLabel}</div>
        <div class="d">{ui.timelineModeDesc}</div>
      </div>
      <div class="sl-c">
        <Segmented
