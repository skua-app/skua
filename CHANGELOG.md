...
- The Setup guide link at the foot of the first-run setup page now opens the README at the setup instructions. It pointed at a section the README does not have, so it landed at the top of the README and left you to scroll for the instructions yourself.
