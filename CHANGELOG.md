...
- The app's icons were redrawn on the Lucide icon set, so the glyphs across the live controls, the event filters, the tab bar, and the settings screens now share one consistent, well-tested look. The icons mean the same things they did before; only their drawing changed.
